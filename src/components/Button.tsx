...
const variantStyles = {
  solid: {
    slate:
      'bg-slate-900 dark:bg-slate-100 dark:hover:bg-slate-300 text-white dark:text-gray-900 hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900',
